...
- [x] Paso 1: el código público del producto es NUESTRO (`MT-<país>-XXXXXX`), no el de CJ — en la ficha, en los dos idiomas y en todas las plazas; el SKU de CJ queda solo para el equipo y los pedidos al proveedor
- [x] Paso 2: auditoría REAL del alcance por país en el panel — listar cada consulta del panel del equipo y comprobar si filtra por el selector de país (órdenes, cobros en sus tres pestañas, compradores, retiros, tablero, productos, comercios)
