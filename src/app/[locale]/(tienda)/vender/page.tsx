...
import { VENDER_EN, VENDER_ES } from "@/contenido/paginas/vender";
...
function contenido(locale: string) {
  return locale === "en" ? VENDER_EN : VENDER_ES;
}
...
/** La pagina para el comercio que evalua vender aqui. Va en el menu de arriba. */
