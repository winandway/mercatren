 ...
 *   apunta aqui.
 * - `avisos@mercatren.com` SOLO ENVIA los avisos del sistema, con el servicio
 *   propio de Mercatren. No recibe nada. Cualquier buzon @mercatren.com sirve
 *   como remitente: el dominio entero esta autorizado y firmado.
 *
 ...
 * (el pie de pagina, los terminos) sin arrastrar nada del servidor.
 */
