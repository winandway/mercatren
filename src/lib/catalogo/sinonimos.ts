...
export const CONCEPTOS: ReadonlyArray<readonly string[]> = [
  ...
  ["repuesto", "repuestos", "refaccion", "refacciones", "autoparte",
   "autopartes", "auto part", "auto parts", "car part", "car parts",
   "spare part", "spare parts"],
  ["carro", "carros", "coche", "coches", "automovil", "automoviles",
   "vehiculo", "vehiculos", "car", "cars", "vehicle", "automotive"],
  ["camioneta", "camionetas", "camion", "camiones", "truck", "trucks"],
  ["llanta", "llantas", "caucho", "cauchos", "neumatico", "neumaticos",
   "goma", "gomas", "tire", "tires", "tyre", "tyres"],
  ...
  // ── Bicicletas y motos ───────────────────────────────────────────────
  ["bicicleta", "bicicletas", "bici", "bicis", "ciclismo", "bike", "bikes",
   "bicycle", "bicycles", "cycling", "e-bike", "ebike"],
  ["casco", "cascos", "helmet", "helmets"],
  ["moto", "motos", "motocicleta", "motocicletas", "motorcycle",
   "motorcycles", "motorbike", "scooter"],
  ...
  ["olla", "ollas", "sarten", "sartenes", "pot", "pots", "pan", "pans",
   "cookware"],
  ...
  // ── Tecnología ───────────────────────────────────────────────────────
  ["celular", "celulares", "telefono", "telefonos", "movil", "moviles",
   "smartphone", "smartphones", "cellphone", "phone", "phones"],
  ["computadora", "computadoras", "ordenador", "laptop", "laptops",
   "computer", "notebook"],
  ["audifonos", "auriculares", "cascos de audio", "headphones", "earphones",
   "earbuds"],
  ["parlante", "parlantes", "corneta", "cornetas", "bocina", "bocinas",
   "speaker", "speakers"],
  ...
  ["zapatilla", "zapatillas", "tenis", "deportivos", "sneaker", "sneakers",
   "running shoes"],
  ["bota", "botas", "boot", "boots"],
  ["camisa", "camisas", "franela", "franelas", "playera", "remera",
   "shirt", "shirts", "t-shirt", "tshirt", "tee"],
  ...
  ["cartera", "carteras", "billetera", "billeteras", "monedero",
  ...
  ["pesa", "pesas", "mancuerna", "mancuernas", "dumbbell", "dumbbells",
   "weights"],
];
