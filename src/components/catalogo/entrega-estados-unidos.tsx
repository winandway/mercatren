...
export function EntregaEstadosUnidos({
   ...
   * QUÉ TROZO SE DIBUJA.
   *
   * El aviso de envío gratis va **arriba, pegado al precio**: es lo que decide
   * la compra. El mapa y el consejo del casillero van **debajo del botón de
   * comprar** — son para el que ya se interesó, y arriba empujaban el precio
   * fuera de la primera pantalla.
   */
  parte?: "todo" | "aviso" | "mapa";
  textos: {
    envioGratis: string;
    aTodoEeuu: string;
    plazo: string;
  ...
  const conAviso = parte === "todo" || parte === "aviso";
  const conMapa = parte === "todo" || parte === "mapa";
  ...
  return (
    <div className="mt-4 space-y-3">
      ...
      {conMapa ? (
        <>
          {/* MÁS CHICO QUE ANTES: aquí abajo acompaña, no manda. Ocupando el ancho
          entero empujaba el precio y el botón de comprar fuera de la primera
          pantalla, que es justo lo que no puede pasar en una ficha. */}
