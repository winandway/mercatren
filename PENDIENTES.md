...
- [ ] 🔴 💻 **2. Estudio de proveedores de dropshipping con almacén en EE. UU.
      (el plan B de CJ).** Con datos de Internet, no de memoria: cuánta gente
      trabaja con CJ, qué experiencias malas hay publicadas y dónde verlas,
      cuál es el más cumplido en entrega y mejor reseñado con almacén EN el
      país, y qué API tiene cada uno. Regla del sistema: el almacén queda en el
      país. Dropi (Colombia) descartado: nunca respondió y su correo rebota.
      Mercados: Estados Unidos primero; quizás México, España y Rumanía (estos
      dos los cubre CJ). La evaluación de CJ con el pedido real arranca el
      lunes 21 sep: medir cuándo llega y cómo llega. **No seguir cargando
      catálogo de CJ hasta tener esta respuesta.**
