...
- [ ] 🟡 💻 **Índice de texto (FTS5) para el buscador.** Hoy sigue siendo un
      `LIKE` que recorre la tabla; con el catálogo creciendo volverá a pesar.
      Tabla aparte llenada por el reloj (una columna nueva no llega sola a
      producción).
