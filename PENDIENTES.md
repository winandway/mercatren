...
### 22 sep 2026 · La página de pago perdió salidas y contacto ✅

Richard abrió el enlace real de MT-C-000004 ($6.483,77) como lo ve su cliente.
Detalle en `HISTORIAL.md` → «LA PÁGINA DE PAGO SE QUEDÓ SIN SALIDA».

- [x] 💻 **El cable no salía**: el atajo de «una sola forma de pago» se tragaba
      el cable y la segunda cuenta, y la pantalla decía «si vas a mandar un
      cable, no uses esta ruta» sin ofrecer otra. Una lista pura
      (`metodos-visibles.ts`) manda ahora las tres decisiones.
- [x] 💻 **No aparecía a quién escribirle**: bloque «¿Tienes dudas sobre este
      cobro?» con el comercio y su correo. En modo callado contesta Mercatren
      y no se filtra ni el nombre ni el correo del comercio.
- [x] 💻 El pie de esa página no llevaba el crédito de Windoce, LLC.
- [x] 💻 **Zelle no salió en ese cobro y la pantalla no dijo por qué** (22 sep
      2026). Al crear el enlace, el panel dice el motivo exacto —tope, mínimo,
      comercio cerrado o receptor sin cargar— con el número que hay que
      cambiar. A quien paga se le sigue sin dar el motivo, a propósito.
- [ ] 👤 **Decidir el tope de Zelle.** Está en $1.000 y la factura de Richard
      era de $6.483,77, por eso su enlace salió sin Zelle. Se cambia en Panel →
      Configuración → «Máximo por cobro (Zelle)».

### 21 sep 2026 · La factura de seis mil con dos laptops ✅

Richard emitiendo una factura real de $6.483,77 y la pantalla le falló cuatro
veces. Todo en vivo el mismo día, detalle en `HISTORIAL.md` → «LA FACTURA DE
SEIS MIL»:

- [x] 💻 `6.483,77` se leía como $6,48 → `leerMontoEnCentavos`.
- [x] 💻 Casilla de cantidad por producto («van DOS»).
- [x] 💻 Las unidades se ajustan al monto (`ajustarAlMonto`): el desglose
      suma exacto y se retiró la pregunta «¿cuál monto cobras?».
- [x] 💻 «Enlaces de cobro» en el menú; el enlace creado vuelve al recargar;
      si el correo no sale, la pantalla lo dice; la lista no calla errores.
- [x] 💻 Interruptor para encender/apagar un seller en `/panel/tiendas`
      (nunca había existido).
- [ ] 👤 **Hacer el cobro real de la factura** desde Cuadrar factura con el
      panel en **Venezuela**, y comprobar que el enlace sale en «Enlaces de
      cobro». Si el correo no sale, la pantalla lo avisa: se manda por
      WhatsApp.

### 21 sep 2026 · El menú del panel estaba muy lento ✅

- [x] 💻 Pantalla de carga del panel (el menú responde al instante), el layout
      en un solo viaje, y Configuración sin traer el catálogo al servidor:
      conteos en SQL, todo en paralelo, auditoría recordada 5 min. Medido en
      producción con `{"accion":"medir-panel"}`. Detalle en `HISTORIAL.md`.

### 20 sep 2026 · EN COLA, en este orden (lo pidió Richard) 🔴

- [x] 💻 **1. Merchant Center, la parte del sitio** (20 sep): mercatren.com
      hablaba de Venezuela justo donde Google mira — la página de entrega decía
      «No enviamos a Estados Unidos», la política traía secciones «Venezuela ·
      …», cada departamento decía «retira en Venezuela» y la portada enseñaba
      videos de comercios venezolanos. Todo por país ahora. La dirección de
      devoluciones ya estaba decidida desde el 18 ago (Mercatren LLC, Novi) y
      queda vigilada por el canario. Detalle en `SEO.md`.
- [ ] 🔴 👤 **1a. Cargar la dirección de devoluciones en YaDominios Cloud.** El
      canario nuevo (`/datos/salud → devoluciones`) salió `falta` en su primera
      lectura: hoy, quien abra una devolución no ve a dónde mandar la caja.
      Variable y formato en `.env.example`; después, republicar.
- [ ] 🔴 👤 **1b. Merchant Center, la parte de la cuenta** (solo Richard puede
      entrar): devoluciones a **30 días** (estaba en `N/A`), envío gratis con
      preparación 1–2 y tránsito 1–3 días hábiles, **Update** en la fuente de
      productos y esperar la revisión. Valores exactos en `SEO.md`.
- [ ] 🔴 💻 **El plazo «2 a 5 días hábiles» NO está medido.** Se promete en
      cada ficha, en `/entrega` y en la política sin una sola entrega real.
      Medir con el pedido de prueba (desde el lunes 21 sep) y ajustar fichas,
      página y Merchant Center a la vez.
- [ ] 🟠 💻 **Correo de «tu pedido ya salió»** con el número de guía: no
      existe (hay «listo» y «entregado»). Un comprador de EE. UU. lo espera.
- [ ] 🟡 💻 **Entrega y devoluciones propias de Chile y Colombia**: hoy ven la
      página de entrega de Venezuela y todas las secciones de devoluciones.
      Va en la lista de `ABRIR-UN-PAIS.md`.
- [x] 💻 **2. Estudio de proveedores con almacén en EE. UU.** (20 sep): hecho,
      en `PLAN-B-PROVEEDORES.md`, con fuentes. CJ es grande pero su nota está
      inflada (Trustpilot le retiró la puntuación por reseñas falsas); plan B
      con API: TopDawg, Wholesale2B y vidaXL; BigBuy para España y Rumanía.
- [ ] 🔴 💻 **Medir a CJ con la vara del estudio** (sección 4): tres pedidos,
      pasa con dos de tres. El primero, desde el lunes 21 sep. **Congelada la
      carga de catálogo nuevo de CJ hasta entonces.**
- [ ] 🟠 👤 **Abrir las cuentas gratis de TopDawg y Wholesale2B y pedir la B2B
      de vidaXL**, para ver catálogo y precios reales. Sin pagar ningún plan.

### 20 sep 2026 · Se sigue bajando en vez de «Siguiente» ✅

- [x] 💻 El catálogo, las búsquedas, los departamentos y las tiendas cargan
      solos al bajar, como la portada; una petición a la vez, y al volver de
      una ficha la lista sigue donde estaba. Detalle en `HISTORIAL.md`.

### 20 sep 2026 · Buscar tardaba 19 s y tumbaba las fichas ✅

- [x] 💻 Emergencia: `?q=ventilador` tardaba 19 s y daba 500, y arrastraba a las
      fichas. La descripción salió de la normalización, el total se cuenta hasta
      un tope, la búsqueda ya no corre dos veces y los robots no la recorren.
      Detalle y candado en `HISTORIAL.md`.
- [x] 💻 El arreglo de raíz: la tabla `texto_de_busqueda`, que el reloj llena
      sola, con el texto de cada producto ya sin acentos. El buscador la usa en
      cuanto está completa. Canario en `/datos/salud → busqueda`.

### 20 sep 2026 · Recepción de paquetes en el warehouse 🟠

- [x] 💻 Proyecto completo de recepción sin personal en el warehouse (planos,
      lista de materiales, plan de armado y video). **Vive fuera del
      repositorio**, en `~/Mercatren-privado/warehouse-recepcion-247/`: es
      seguridad física de la bodega y este repositorio es público.
- [x] 💻 Estudio de lo que ya existe en el mercado: cómo reciben hoy las bodegas
      cerradas y qué se compra hecho, con precios verificados. **La jaula sí se
      compra en kit; la compuerta grande no existe** (la boca más grande que se
      fabrica es de 71 × 38 cm). También fuera del repositorio.
- [x] 💻 **La jaula baja (21 sep):** con las fotos y medidas reales de Richard
      (puerta de 10 ft, abertura de 25 in, fondo de 4 ft), lluvia de ideas
      dibujada sobre sus propias fotos: una pieza contra dos módulos. Fuera del
      repositorio, como todo lo del warehouse.
- [ ] 🟠 👤 **Para el plano del ingeniero faltan tres datos de Richard:** el
      ancho por dentro de pared a cerca medido con cinta, la caja más grande que
      espera recibir, y si va la idea de dos módulos (la recomendada) o la de una
      pieza.
- [ ] 🟡 👤 **Lo que falta para arrancar** (solo lo puede resolver Richard):
      permiso del landlord por escrito, confirmar con el fire marshal si esa
      puerta es ruta de salida, llamada al seguro, y las 9 medidas de la
      puerta tomadas con cinta.
...
- [x] 💻 Tercera parte (18 sep): la foto de las tarjetas sale de
      `fotos_de_producto` (una fila por producto, elegida en código) y la
      sincronización con CJ ya no recorre el catálogo cada minuto (colas
      guardadas del afinado y del stock, barrido cada 15 min, conteo de
      fotos cada media hora). Historial: «La tercera parte».
- [x] 💻 Cuarta parte (18 sep): listados ya ordenados (parrilla, catálogo,
      bandas) guardados por el reloj cada 5 min; revisor de fotos y
      traductor con colas guardadas; barrido solo sobre lo que cambió;
      similares por índice; página de tienda en dos fases con el total
      desde la foto. Historial: «La cuarta parte».
- [x] 💻 Quinta parte (18 sep): la trampa del índice de estado (búsquedas
      por id solo con la clave primaria, `+estado` junto a índices de orden,
      `PRAGMA optimize` diario y ANALYZE por la puerta), la foto de 1.000
      ids solo la rehace el reloj con intento reclamado, y la consulta de
      pedidos del vigilante con EXISTS e índice. Historial: «La quinta parte».
...
- [x] 💻 Seguimiento con número de guía en el pedido (25 sep): en el
      detalle y en «Mis pedidos». Y de paso, la subconsulta que ponía «0
      artículos» y «Pagar ahora» a quien ya pagó. Ver `HISTORIAL.md`. Antes: el detalle
