...
- [ ] 🔴 💻 **1. Retomar Merchant Center.** Está parado esperando la dirección
      de devoluciones. Ahora que Estados Unidos quedó solo (Venezuela se mudó
      a su dominio), reevaluar: qué dirección se declara (se habló de la casa
      de Richard, la misma del registro de la LLC), qué exige Google para
      devoluciones cuando el proveedor no las recibe, y terminar los datos
      para que Google evalúe la cuenta.
