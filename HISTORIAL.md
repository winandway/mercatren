# Historial del proyecto Mercatren.com

> **Esto NO se lee entero.** Es el diario del proyecto: qué se rompió, por qué,
> y qué se hizo. Vive aparte desde el 6 sep 2026 porque pesaba 332 KB y viajaba
> dentro de CADA mensaje de la sesión — unos 85.000 tokens por turno, gastados
> en releer historia que casi nunca hacía falta.
>
> **Cómo se usa:** `CLAUDE.md` tiene las reglas vigentes y un índice. Cuando
> vayas a tocar una pieza, busca su sección AQUÍ y léela primero. Cada sección
> explica un fallo real y el candado que lo tranca: romperlo cuesta dinero.
