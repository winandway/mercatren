...
| US               | Compra a CJ desde «Probar una compra» | ⚠️ CONSTRUIDO, SIN PROBAR     | 5 sep 2026 · **Primer intento real:** `PRUEBA-20260905184139` ($11,40) se creó bien y CJ lo dejó en UNPAID; el módulo intentó confirmarlo (bug: un UNPAID se paga, no se confirma) y el pago no se intentó. Compuerta arreglada + botón «Pagar la prueba pendiente». **Queda probado cuando ese pedido salga «pagado» y el saldo de CJ baje a ~$138,60.** |
