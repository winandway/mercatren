...
| US               | Compra a CJ desde «Probar una compra» | ⚠️ CONSTRUIDO, SIN PROBAR     | 5 sep 2026: Panel → Equipo → Probar una compra crea, confirma (reparando el transporte si el almacén no tiene stock) y paga del saldo, enseñando la respuesta cruda de CJ. **No se ha pulsado todavía.** Queda probado cuando una compra `PRUEBA-…` salga «pagado» y el saldo de CJ baje. MT-000011 falló ANTES de que existiera el arreglo del transporte (2 sep). |
